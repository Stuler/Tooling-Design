...
class Window():
    def __init__(self, window):
        ...
        jedn11.grid(row=9, column=3)

        jedn12 = Label(window, text = "mm")
        jedn12.grid(row=10, column=3)

        jedn15 = Label(window, text = "mm")
        jedn15.grid(row=11, column=3)

        jedn13 = Label(window, text = "°")
        jedn13.grid(row=12, column=3)

        jedn14 = Label(window, text = "-")
        jedn14.grid(row=13, column=3)

        jedn16 = Label(window, text = "-")
        jedn16.grid(row=14, column=3)
